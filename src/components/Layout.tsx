          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <Button 
                ...
                className="p-2 transition-all duration-200 hover:scale-105 active:scale-95 text-gray-950 bg-blue-900 hover:bg-gray-800"
              >
          ...
          {bottomNavItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-xs font-medium transition-all duration-200 ${isActive ? 'animate-fade-in' : ''}`}>
                  {item.label}
                </span>
                {isActive && (
                  <div className="absolute bottom-0 w-8 h-1 rounded-full bg-gradient-to-r from-obeyyo-pink to-obeyyo-blue animate-scale-in" />
                )}
              </Link>
            );
          })}
