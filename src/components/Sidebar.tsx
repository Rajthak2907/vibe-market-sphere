...
const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
  const menuItems = [
    { name: "Men", path: "/men", icon: null },
    { name: "Women", path: "/women", icon: null },
    { name: "Kids", path: "/kids", icon: null },
    { name: "Home & Living", path: "/accessories", icon: null },
    { name: "Beauty", path: "/accessories", icon: null },
  ];

  const studioItems = [
    { name: "Myntra Studio", path: "/", badge: "NEW", color: "bg-pink-500" },
    { name: "Myntra Mall", path: "/", badge: "NEW", color: "bg-green-500" },
    { name: "Myntra Insider", path: "/", badge: null, color: null },
  ];

  const otherItems = [
    { name: "Gift Cards", path: "/", icon: Gift },
    { name: "Contact Us", path: "/", icon: Phone },
    { name: "FAQs", path: "/", icon: HelpCircle },
    { name: "Legal", path: "/", icon: FileText },
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="bg-gradient-to-r from-yellow-400 to-orange-400 p-4 relative">
            ...
            <div className="mt-2">
              ...
              <Button 
                size="sm" 
                className="mt-2 bg-white text-orange-600 hover:bg-gray-100 text-xs font-bold px-3 py-1 h-6"
              >
                SIGN UP LOGIN
              </Button>
            </div>
            ...
            <div className="py-4">
              {menuItems.map((item) => (
                <Link
                  ...
                  to={item.path}
                  onClick={onClose}
                  className="flex items-center justify-between px-6 py-3 text-gray-700 hover:bg-gray-50 transition-colors"
                >
          ...
          <div className="border-t border-gray-200 p-4 bg-gradient-to-r from-pink-50 to-purple-50">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <Button 
                  size="sm" 
                  className="mt-2 bg-gradient-to-r from-obeyyo-pink to-obeyyo-blue text-white text-xs font-bold h-7"
                >
                  GET OBEYYO APP
                </Button>
              </div>
