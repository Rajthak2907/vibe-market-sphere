...
interface MenBrandsSectionProps {
  brandsFlexData: Brand[];
  topBrandsProducts: Product[];
  tshirtCategories: TShirtCategory[];
}

const MenBrandsSection = ({ brandsFlexData, topBrandsProducts, tshirtCategories }: MenBrandsSectionProps) => {
  return (
    <>
...
export default MenBrandsSection;
