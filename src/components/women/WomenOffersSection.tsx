...
interface WomenOffersSectionProps {
  couponsData: Coupon[];
...
const WomenOffersSection = ({ couponsData, biggestOfferProducts, everythingInOfferCategories, promoBanners }: WomenOffersSectionProps) => {
  return (
    <>
...
export default WomenOffersSection;
