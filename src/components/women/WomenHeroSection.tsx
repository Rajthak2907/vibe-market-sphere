...
interface WomenHeroSectionProps {
  carouselImages: CarouselImage[];
  categories: Category[];
}

const WomenHeroSection = ({ carouselImages, categories }: WomenHeroSectionProps) => {
  const tabs = [
  ...
  return (
    <>
      <FashionCarousel 
        ...
        subtitle="Explore the latest trends in women's clothing" 
      />
