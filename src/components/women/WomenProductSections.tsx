...
interface WomenProductSectionsProps {
...
const WomenProductSections = ({ 
  ...
  dealEndTime, 
  products 
}: WomenProductSectionsProps) => {
  return (
    <>
      <section className="px-3">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-bold text-gray-800">💄 Women's Beauty & Cosmetics</h2>
      ...
      <section className="px-3">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-bold text-gray-800">⌚ Women's Watches & Jewelry</h2>
          <Button variant="outline" size="sm" className="text-xs border-obeyyo-red text-obeyyo-red hover:bg-obeyyo-red hover:text-white rounded-lg px-3 py-1.5">
            View All
          </Button>
        </div>
...
export default WomenProductSections;
