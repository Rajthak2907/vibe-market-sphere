...
const Layout = ({ children }: LayoutProps) => {
  ...
  const quickCategories = [
    { name: "Men", path: "/men", color: "#fc2682", icon: "https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?w=100&h=100&fit=crop&crop=face" },
    { name: "Women", path: "/women", color: "#fc334d", icon: "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=100&h=100&fit=crop&crop=face" },
    { name: "Kids", path: "/kids", color: "#f9b704", icon: "https://images.unsplash.com/photo-1535268647677-300dbf3d78d1?w=100&h=100&fit=crop&crop=face" },
    { name: "Beauty", path: "/beauty", color: "#fc334d", icon: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=100&h=100&fit=crop&crop=center" },
    { name: "Footwear", path: "/footwear", color: "#08a0ef", icon: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=100&h=100&fit=crop&crop=center" },
    { name: "Accessories", path: "/accessories", color: "#fb8619", icon: "https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?w=100&h=100&fit=crop&crop=center" }
  ];
