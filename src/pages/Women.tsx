  ...
  return (
    <Layout>
      <div className="bg-white min-h-screen">
        ...
        <div className="bg-gradient-to-r from-[#FF6B9D] to-[#FF9A6B] text-white px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl sm:text-4xl font-bold mb-2">Women's Fashion</h1>
            <p className="text-lg opacity-90">Explore trendy and stylish women's collection</p>
          </div>
        </div>
